%{
    ...
    Date:         [July 2025]
    Description:  [CBS Decay Transition Defected Banded Toeplitz]
    --------------------------------------------------------------
%}
...
% --- Parameters ---
    n = 30;      % Matrix size
    p = 5.8;     % Decay rate upwards
    q = 5.8;     % Decay rate downwards
    bandw = 12;  % Bandwidth of the Toeplitz matrix
...
% --- Plot the results ---
    ...
    legend('', 'Jaffard Estimate', 'Complex band structure', 'Interpreter', 'latex', 'Location', 'southwest');
    grid on;
